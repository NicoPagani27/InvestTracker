  ...
  return (
    <Card className="w-full max-w-md border-border/50 bg-card/50 backdrop-blur">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl text-foreground">InvestTracker</CardTitle>
        <CardDescription>Ingresa a tu cuenta para gestionar tus inversiones</CardDescription>
      </CardHeader>
      <CardContent>
